      ...
      try 
      {
        ...
        while (line!=null) {     
          ...
          while(s.hasNextFloat()) {
            st=s.nextFloat();           
            if (st!=2.0) {
              cells[j][i].urbanareas=false;
            }
            else {
              cells[j][i].urbanareas=true;
            }     
            i++;
          }
          line=reader.readLine();
      ...
      try 
      {
        ...
        while (line!=null) {     
          ...
          while(s.hasNextFloat()) {
            st=s.nextFloat();           
            if (st==1.0) {
              cells[j][i].inlandwater=false;
            }
            else {
              cells[j][i].inlandwater=true;
            }
            i++;
          }
        line=reader.readLine();
      ...
      try 
      {
        ...
        while (line!=null) {     
          ...
          while(s.hasNextFloat()) {
            st=s.nextFloat();           
            if (st<1.0) {
              cells[j][i].protectedareas=false;
            }
            else {
              cells[j][i].protectedareas=true;
            }
            i++;
          }
        line=reader.readLine();
